...
export default function Gasolina({gasolina, tanque, datosVehicule}) {
  ...
  return (
    <div className={classes.conta2}   >
      ...
      <div  style={{display:'flex',boxShadow: "rgba(149, 157, 165, 0.6) 0px 5px 10px",alignItems:'center', flexDirection:'row',justifyContent:'center', width:'100%',height:'40px', backgroundColor:'#f1f1f1', margin:'0 auto', borderRadius:'10px'}}>
